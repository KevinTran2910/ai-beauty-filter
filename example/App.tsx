/**
 * AI Beauty Filter — Expo demo
 *
 * Giống App.tsx bản bare React Native, nhưng thay react-native-image-picker
 * bằng expo-image-picker để "thuần Expo" hơn. Phần native (GPUPixelImageView /
 * GPUPixelCameraView) dùng nguyên xi từ module beautyfilter-sdk.
 *
 * Chế độ Camera (real-time) chỉ chạy đầy đủ trên iPhone thật.
 */
